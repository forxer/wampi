...
return [
    ...
    'config.disable.debug' => 'Désactiver le mode debug',

    'config.wampserver.dir' => 'Répertoire de Wampserver',
    'config.projects.dirs' => 'Chemins des répertoires où se situent les projets',
    ...
    'config.check.stables.release' => 'Vérifier les versions stables',
    'config.check.dev.release' => 'Vérifier les versions de développement',
